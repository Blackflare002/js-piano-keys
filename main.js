...
let nextTwo = document.getElementById(
	"second-next-line"
);
let nextThree = document.getElementById(
	"third-next-line"
);
let startOver = document.getElementById(
	"fourth-next-line"
);

// This variable stores the '-END' lyric element
let lastLyric = document.getElementById(
	"column-optional"
);
...
nextOne.onclick = () => {
	...
	nextOne.hidden = true;
	const noteFive = document.getElementById(
		"letter-note-five"
	);
	noteFive.innerHTML = "D";
	const noteSix = document.getElementById(
		"letter-note-six"
	);
	noteSix.innerHTML = "C";
};
...
nextTwo.onclick = () => {
	...
	const noteThree = document.getElementById(
		"letter-note-three"
	);
